...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m2893getSrcOver0nO6VwU();
    }
    ...
    public long mo2824getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo2830setColor8_81llA(long color) {
        AndroidPaint_androidKt.m2836setNativeColor4WTKRHQ(this.internalPaint, color);
    }
    ...
    public void mo2829setBlendModes9anfk8(int value) {
        if (!BlendMode.m2862equalsimpl0(this._blendMode, value)) {
            this._blendMode = value;
            AndroidPaint_androidKt.m2835setNativeBlendModeGB0RdKg(this.internalPaint, value);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo2828getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo2834setStylek9PVt8s(int value) {
        AndroidPaint_androidKt.m2840setNativeStyle5YerkU(this.internalPaint, value);
    }
    ...
    public int mo2826getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo2832setStrokeCapBeK7IIE(int value) {
        AndroidPaint_androidKt.m2838setNativeStrokeCapCSYIeUk(this.internalPaint, value);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo2827getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo2833setStrokeJoinWw9F2mQ(int value) {
        AndroidPaint_androidKt.m2839setNativeStrokeJoinkLtJ_vA(this.internalPaint, value);
    }
    ...
    public int mo2825getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo2831setFilterQualityvDHp3xo(int value) {
        AndroidPaint_androidKt.m2837setNativeFilterQuality50PEsBU(this.internalPaint, value);
    }
