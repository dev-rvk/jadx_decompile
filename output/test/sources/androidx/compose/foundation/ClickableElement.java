...
public final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    */
    ...
    public void update(ClickableNode node) {
        ...
        node.m205updateXHw0xAI(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((result3 + (role != null ? Role.m4565hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
