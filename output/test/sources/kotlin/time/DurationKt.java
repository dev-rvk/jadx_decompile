...
public final class DurationKt {
    ...
    private static final long m7067timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m6978timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m7066timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m6977timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m6940constructorimpl(normalNanos << 1);
    }

    public static final long durationOfMillis(long normalMillis) {
        return Duration.m6940constructorimpl((normalMillis << 1) + 1);
    }

    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m6940constructorimpl((normalValue << 1) + unitDiscriminator);
    }
