...
public final class SearchBarColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2950equalsimpl0(this.containerColor, ((SearchBarColors) other).containerColor) && Color.m2950equalsimpl0(this.dividerColor, ((SearchBarColors) other).dividerColor) && Intrinsics.areEqual(this.inputFieldColors, ((SearchBarColors) other).inputFieldColors);
    }

    public int hashCode() {
        int result = Color.m2956hashCodeimpl(this.containerColor);
        return (((result * 31) + Color.m2956hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
