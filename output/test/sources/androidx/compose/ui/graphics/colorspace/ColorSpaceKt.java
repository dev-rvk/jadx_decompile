...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m3361connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m3375getPerceptualuksYyKA();
        }
        return m3360connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4 */
    public static final Connector m3360connectYBCOT_4(ColorSpace connect, ColorSpace destination, int intent) {
        ...
        if (connect == ColorSpaces.INSTANCE.getSrgb()) {
            ...
            if (destination == ColorSpaces.INSTANCE.getOklab() && RenderIntent.m3370equalsimpl0(intent, RenderIntent.INSTANCE.m3375getPerceptualuksYyKA())) {
                return Connector.INSTANCE.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (connect == ColorSpaces.INSTANCE.getOklab() && destination == ColorSpaces.INSTANCE.getSrgb() && RenderIntent.m3370equalsimpl0(intent, RenderIntent.INSTANCE.m3375getPerceptualuksYyKA())) {
        ...
        if (ColorModel.m3349equalsimpl0(connect.getModel(), ColorModel.INSTANCE.m3356getRgbxdoWZVw()) && ColorModel.m3349equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m3356getRgbxdoWZVw())) {
    ...
    public static final ColorSpace adapt(ColorSpace $this$adapt, WhitePoint whitePoint, Adaptation adaptation) {
        ...
        if (ColorModel.m3349equalsimpl0($this$adapt.getModel(), ColorModel.INSTANCE.m3356getRgbxdoWZVw())) {
