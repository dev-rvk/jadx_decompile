...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5218constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m5218constructorimpl((float) 48.0d);
    ...
    public final float m2036getActiveIndicatorWidthD9Ej5fM() {
