...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo241measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (OffsetPxNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeable, IntOffset.m5336getXimpl(offsetValue), IntOffset.m5337getYimpl(offsetValue), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(layout, placeable, IntOffset.m5336getXimpl(offsetValue), IntOffset.m5337getYimpl(offsetValue), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }
