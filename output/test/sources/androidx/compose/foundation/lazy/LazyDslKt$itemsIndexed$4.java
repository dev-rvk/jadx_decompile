...
public final class LazyDslKt$itemsIndexed$4 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final void invoke(LazyItemScope items, int it, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1091073711, $dirty, -1, "androidx.compose.foundation.lazy.itemsIndexed.<anonymous> (LazyDsl.kt:179)");
        }
        this.$itemContent.invoke(items, Integer.valueOf(it), this.$items.get(it), $composer, Integer.valueOf(($dirty & 14) | ($dirty & 112)));
        if (ComposerKt.isTraceInProgress()) {
