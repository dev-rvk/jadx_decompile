...
final class RequiredMaxIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long mo438calculateContentConstraintsl58MMJ0(MeasureScope calculateContentConstraints, Measurable measurable, long constraints) {
        ...
        int width = measurable.maxIntrinsicWidth(Constraints.m5173getMaxHeightimpl(constraints));
        return Constraints.INSTANCE.m5184fixedWidthOenEA2s(width);
    }
