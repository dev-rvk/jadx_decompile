...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m4724getMinimpl(selection);
        this.selectionEnd = TextRange.m4723getMaximpl(selection);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int start = TextRange.m4724getMinimpl(selection);
        int end = TextRange.m4723getMaximpl(selection);
    ...
    public final TextRange m4866getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m4714boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release, reason: not valid java name */
    public final long m4867getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m4868updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m4724getMinimpl(newSelection));
        setSelectionEnd(TextRange.m4723getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long compositionRange = TextRangeKt.TextRange(this.compositionStart, this.compositionEnd);
            long newComposition = EditingBufferKt.m4868updateRangeAfterDeletepWDy79M(compositionRange, deleteRange);
            if (TextRange.m4720getCollapsedimpl(newComposition)) {
                commitComposition$ui_text_release();
            } else {
                this.compositionStart = TextRange.m4724getMinimpl(newComposition);
                this.compositionEnd = TextRange.m4723getMaximpl(newComposition);
            }
        }
    }
