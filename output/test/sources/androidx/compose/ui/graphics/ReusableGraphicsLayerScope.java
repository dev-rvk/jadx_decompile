...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m3333getCenterSzJe1aQ();
    private Shape shape = RectangleShapeKt.getRectangleShape();
    private int compositingStrategy = CompositingStrategy.INSTANCE.m3034getAutoNrFUSI();
    private long size = Size.INSTANCE.m2787getUnspecifiedNHjbRc();
    ...
    public void mo3135setAmbientShadowColor8_81llA(long j) {
    ...
    public void mo3137setSpotShadowColor8_81llA(long j) {
    ...
    public void mo3138setTransformOrigin__ExYCQ(long j) {
    ...
    public void mo3136setCompositingStrategyaDBOjCE(int i) {
    ...
    public void m3254setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo3135setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo3137setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo3138setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m3333getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo3136setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m3034getAutoNrFUSI());
        m3254setSizeuvyYCjk(Size.INSTANCE.m2787getUnspecifiedNHjbRc());
    }
}
