...
public interface LayoutCoordinates {
    ...
    long mo4194localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource);

    /* renamed from: localToRoot-MK-Hz9U, reason: not valid java name */
    long mo4195localToRootMKHz9U(long relativeToLocal);

    /* renamed from: localToWindow-MK-Hz9U, reason: not valid java name */
    long mo4196localToWindowMKHz9U(long relativeToLocal);

    /* renamed from: windowToLocal-MK-Hz9U, reason: not valid java name */
    long mo4198windowToLocalMKHz9U(long relativeToWindow);
    ...
    public static final class DefaultImpls {
        ...
        public static void m4199transformFromEL8BTi8(LayoutCoordinates $this, LayoutCoordinates sourceCoordinates, float[] matrix) {
            Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            LayoutCoordinates.super.mo4197transformFromEL8BTi8(sourceCoordinates, matrix);
        }
    }
    ...
    /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
    default void mo4197transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
