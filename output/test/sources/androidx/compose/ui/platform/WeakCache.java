...
public final class WeakCache<T> {
    ...
    public final T pop() {
        ...
        while (this.values.isNotEmpty()) {
            ...
            MutableVector this_$iv = this.values;
            T t = mutableVector.removeAt(this_$iv.getSize() - 1).get();
            if (t != null) {
                return t;
            }
        }
