...
public final class StateData {
    ...
    private StateData(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode) {
        ...
        this.calendarModel = CalendarModel_androidKt.CalendarModel();
        ...
        mutableStateOf$default4 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m1486boximpl(initialDisplayMode), null, 2, null);
    ...
    public final CalendarMonth getCurrentMonth() {
        return this.calendarModel.getMonth(this.calendarModel.getToday());
    }
    ...
    public final void m1713switchDisplayModevCnGnXg(int displayMode) {
        ...
        this.displayMode.setValue(DisplayMode.m1486boximpl(displayMode));
    }

    /* compiled from: DatePicker.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00010\u0004¨\u0006\u0006"}, d2 = {"Landroidx/compose/material3/StateData$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/material3/StateData;", "material3_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
        ...
        public final Saver<StateData, Object> Saver() {
            return ListSaverKt.listSaver(new Function2<SaverScope, StateData, List<? extends Object>>() { // from class: androidx.compose.material3.StateData$Companion$Saver$1
                ...
                public final List<Object> invoke(SaverScope listSaver, StateData it) {
                    ...
                    return CollectionsKt.listOf(valueOf, value2 != null ? Long.valueOf(value2.getUtcTimeMillis()) : null, Long.valueOf(it.getDisplayedMonth().getStartUtcTimeMillis()), Integer.valueOf(it.getYearRange().getFirst()), Integer.valueOf(it.getYearRange().getLast()), Integer.valueOf(it.getDisplayMode().getValue().getValue()));
                }
                ...
                public final StateData invoke2(List<? extends Object> value) {
                    ...
                    return new StateData(l, l2, l3, intRange, DisplayMode.m1487constructorimpl(((Integer) obj3).intValue()), null);
                }
            });
        }
    }
