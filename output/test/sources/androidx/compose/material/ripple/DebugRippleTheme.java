...
public final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1121defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long m1288defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1288defaultRippleColor5vOe2sY(Color.INSTANCE.m2975getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha m1287defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1287defaultRippleAlphaDxMtmZc(Color.INSTANCE.m2975getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
