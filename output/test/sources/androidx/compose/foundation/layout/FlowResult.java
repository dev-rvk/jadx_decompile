...
public final class FlowResult {
    ...
    public FlowResult(int mainAxisTotalSize, int crossAxisTotalSize, MutableVector<RowColumnMeasureHelperResult> items) {
        Intrinsics.checkNotNullParameter(items, "items");
        this.mainAxisTotalSize = mainAxisTotalSize;
        this.crossAxisTotalSize = crossAxisTotalSize;
        this.items = items;
    }
