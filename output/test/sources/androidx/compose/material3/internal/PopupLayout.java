...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    */
    ...
    public final IntSize m1999getPopupContentSizebOM6tXw() {
        State $this$getValue$iv = this.popupContentSize;
        return (IntSize) $this$getValue$iv.getValue();
    }

    /* renamed from: setPopupContentSize-fhxjrPA, reason: not valid java name */
    public final void m2000setPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public final void updatePosition() {
        IntSize m1999getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (m1999getPopupContentSizebOM6tXw = m1999getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long popupContentSize = m1999getPopupContentSizebOM6tXw.getPackedValue();
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r9) {
        ...
        L67:
            ...
            androidx.compose.ui.geometry.Offset r1 = androidx.compose.ui.geometry.Offset.m2699boximpl(r6)
        L83:
