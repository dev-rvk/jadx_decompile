...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        ...
        node.m553setMinWidth0680j_4(this.minWidth);
        node.m552setMinHeight0680j_4(this.minHeight);
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("minWidth", Dp.m5216boximpl(this.minWidth));
        $this$inspectableProperties.getProperties().set("minHeight", Dp.m5216boximpl(this.minHeight));
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        return (other instanceof UnspecifiedConstraintsElement) && Dp.m5223equalsimpl0(this.minWidth, ((UnspecifiedConstraintsElement) other).minWidth) && Dp.m5223equalsimpl0(this.minHeight, ((UnspecifiedConstraintsElement) other).minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m5224hashCodeimpl(this.minWidth) * 31) + Dp.m5224hashCodeimpl(this.minHeight);
    }
}
