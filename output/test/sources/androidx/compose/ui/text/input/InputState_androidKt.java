...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m4724getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m4723getMaximpl(textFieldValue.getSelection());
