...
public final class ViewTreeLifecycleOwner {
    ...
    public static final LifecycleOwner get(View $this$findViewTreeLifecycleOwner) {
        ...
        return (LifecycleOwner) SequencesKt.firstOrNull(SequencesKt.mapNotNull(SequencesKt.generateSequence($this$findViewTreeLifecycleOwner, new Function1<View, View>() { // from class: androidx.lifecycle.ViewTreeLifecycleOwner$findViewTreeLifecycleOwner$1
