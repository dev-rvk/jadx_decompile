...
final class ClickablePointerInputNode$pointerInput$2 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
    ...
    public final Object m206invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (this.this$0.getEnabled()) {
                    this.label = 1;
                    if (this.this$0.m151handlePressInteractiond4ec7I($this$detectTapAndPress, offset, this) == coroutine_suspended) {
