...
public final class IconToggleButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof IconToggleButtonColors) && Color.m2950equalsimpl0(this.containerColor, ((IconToggleButtonColors) other).containerColor) && Color.m2950equalsimpl0(this.contentColor, ((IconToggleButtonColors) other).contentColor) && Color.m2950equalsimpl0(this.disabledContainerColor, ((IconToggleButtonColors) other).disabledContainerColor) && Color.m2950equalsimpl0(this.disabledContentColor, ((IconToggleButtonColors) other).disabledContentColor) && Color.m2950equalsimpl0(this.checkedContainerColor, ((IconToggleButtonColors) other).checkedContainerColor) && Color.m2950equalsimpl0(this.checkedContentColor, ((IconToggleButtonColors) other).checkedContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m2956hashCodeimpl(this.contentColor)) * 31) + Color.m2956hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2956hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2956hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m2956hashCodeimpl(this.checkedContentColor);
    }
}
