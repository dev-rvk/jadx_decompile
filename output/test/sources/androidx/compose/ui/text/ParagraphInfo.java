...
public final /* data */ class ParagraphInfo {
    ...
    public final long m4623toLocalMKHz9U(long $this$toLocal_u2dMK_u2dHz9U) {
        return OffsetKt.Offset(Offset.m2710getXimpl($this$toLocal_u2dMK_u2dHz9U), Offset.m2711getYimpl($this$toLocal_u2dMK_u2dHz9U) - this.top);
    }

    public final Rect toGlobal(Rect $this$toGlobal) {
        Intrinsics.checkNotNullParameter($this$toGlobal, "<this>");
        return $this$toGlobal.m2747translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path $this$toGlobal) {
        Intrinsics.checkNotNullParameter($this$toGlobal, "<this>");
        $this$toGlobal.mo2846translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return $this$toGlobal;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m4622toGlobalGEjPoXI(long $this$toGlobal_u2dGEjPoXI) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4726getStartimpl($this$toGlobal_u2dGEjPoXI)), toGlobalIndex(TextRange.m4721getEndimpl($this$toGlobal_u2dGEjPoXI)));
    }
}
