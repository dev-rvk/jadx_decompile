...
public final class IconButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof IconButtonColors) && Color.m2950equalsimpl0(this.containerColor, ((IconButtonColors) other).containerColor) && Color.m2950equalsimpl0(this.contentColor, ((IconButtonColors) other).contentColor) && Color.m2950equalsimpl0(this.disabledContainerColor, ((IconButtonColors) other).disabledContainerColor) && Color.m2950equalsimpl0(this.disabledContentColor, ((IconButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Color.m2956hashCodeimpl(this.contentColor)) * 31) + Color.m2956hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2956hashCodeimpl(this.disabledContentColor);
    }
}
