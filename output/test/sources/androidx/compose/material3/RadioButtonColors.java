...
public final class RadioButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof RadioButtonColors) && Color.m2950equalsimpl0(this.selectedColor, ((RadioButtonColors) other).selectedColor) && Color.m2950equalsimpl0(this.unselectedColor, ((RadioButtonColors) other).unselectedColor) && Color.m2950equalsimpl0(this.disabledSelectedColor, ((RadioButtonColors) other).disabledSelectedColor) && Color.m2950equalsimpl0(this.disabledUnselectedColor, ((RadioButtonColors) other).disabledUnselectedColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Color.m2956hashCodeimpl(this.unselectedColor)) * 31) + Color.m2956hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m2956hashCodeimpl(this.disabledUnselectedColor);
    }
}
