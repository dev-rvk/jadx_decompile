...
public final class UStringsKt {
    ...
    public static final String m6927toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m6929toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m6928toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m6926toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m5710constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m5627boximpl(UByte.m5633constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m5710constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m5890boximpl(UShort.m5896constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m5710constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m5710constructorimpl(result * uradix);
            result = UInt.m5710constructorimpl(UInt.m5710constructorimpl(digit) + result2);
            compare2 = Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
        }
        return UInt.m5704boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m5789constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m5789constructorimpl(result * uradix);
            result = ULong.m5789constructorimpl(ULong.m5789constructorimpl(UInt.m5710constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m5783boximpl(result);
    }
}
