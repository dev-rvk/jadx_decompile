...
final class UnspecifiedConstraintsNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ UnspecifiedConstraintsNode(float f, float f2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM() : f2, null);
    }
    ...
    public MeasureResult mo241measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        if (!Dp.m5223equalsimpl0(this.minWidth, Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM()) && Constraints.m5176getMinWidthimpl(constraints) == 0) {
            m5176getMinWidthimpl = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(measure.mo323roundToPx0680j_4(this.minWidth), Constraints.m5174getMaxWidthimpl(constraints)), 0);
        } else {
        ...
        if (!Dp.m5223equalsimpl0(this.minHeight, Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM()) && Constraints.m5175getMinHeightimpl(constraints) == 0) {
            m5175getMinHeightimpl = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(measure.mo323roundToPx0680j_4(this.minHeight), Constraints.m5173getMaxHeightimpl(constraints)), 0);
        } else {
            m5175getMinHeightimpl = Constraints.m5175getMinHeightimpl(constraints);
        }
        long wrappedConstraints = ConstraintsKt.Constraints(m5176getMinWidthimpl, m5174getMaxWidthimpl, m5175getMinHeightimpl, Constraints.m5173getMaxHeightimpl(constraints));
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return RangesKt.coerceAtLeast(measurable.minIntrinsicWidth(height), !Dp.m5223equalsimpl0(this.minWidth, Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM()) ? $this$minIntrinsicWidth.mo323roundToPx0680j_4(this.minWidth) : 0);
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return RangesKt.coerceAtLeast(measurable.maxIntrinsicWidth(height), !Dp.m5223equalsimpl0(this.minWidth, Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM()) ? $this$maxIntrinsicWidth.mo323roundToPx0680j_4(this.minWidth) : 0);
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return RangesKt.coerceAtLeast(measurable.minIntrinsicHeight(width), !Dp.m5223equalsimpl0(this.minHeight, Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM()) ? $this$minIntrinsicHeight.mo323roundToPx0680j_4(this.minHeight) : 0);
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return RangesKt.coerceAtLeast(measurable.maxIntrinsicHeight(width), !Dp.m5223equalsimpl0(this.minHeight, Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM()) ? $this$maxIntrinsicHeight.mo323roundToPx0680j_4(this.minHeight) : 0);
    }
}
