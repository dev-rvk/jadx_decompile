...
public final /* data */ class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m183copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush, Shape shape, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m185copy8Feqmps(f, brush, shape);
    }
    ...
    public final BorderModifierNodeElement m185copy8Feqmps(float width, Brush brush, Shape shape) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5223equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m5224hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m5229toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }

    /* renamed from: getWidth-D9Ej5fM, reason: not valid java name */
    public final float m186getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public void update(BorderModifierNode node) {
        ...
        node.m182setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("width", Dp.m5216boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            $this$inspectableProperties.getProperties().set("color", Color.m2939boximpl(((SolidColor) this.brush).getValue()));
            $this$inspectableProperties.setValue(Color.m2939boximpl(((SolidColor) this.brush).getValue()));
        } else {
