...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo15measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        return MeasureScope.layout$default(measure, Constraints.m5174getMaxWidthimpl(constraints), Constraints.m5173getMaxHeightimpl(constraints), null, placementBlock, 4, null);
    }
}
