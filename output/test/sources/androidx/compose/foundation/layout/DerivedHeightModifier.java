...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        if (height != 0) {
            childConstraints = Constraints.m5164copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5176getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5174getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5175getMinHeightimpl(constraints) : height, (r12 & 8) != 0 ? Constraints.m5173getMaxHeightimpl(constraints) : height);
            final Placeable placeable = measurable.mo4186measureBRTryo0(childConstraints);
            return MeasureScope.layout$default(measure, placeable.getWidth(), height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$2
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof DerivedHeightModifier) {
            return Intrinsics.areEqual(this.insets, ((DerivedHeightModifier) other).insets) && Intrinsics.areEqual(this.heightCalc, ((DerivedHeightModifier) other).heightCalc);
        }
        return false;
    }
