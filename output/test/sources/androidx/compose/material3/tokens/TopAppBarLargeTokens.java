...
public final class TopAppBarLargeTokens {
    ...
    private static final float ContainerHeight = Dp.m5218constructorimpl((float) 152.0d);
    ...
    public final float m2495getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2496getTrailingIconSizeD9Ej5fM() {
