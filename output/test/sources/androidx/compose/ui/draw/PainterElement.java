...
final /* data */ class PainterElement extends ModifierNodeElement<PainterModifier> {
    ...
    public int hashCode() {
        ...
        return ((((((((hashCode + i) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.hashCode(this.alpha)) * 31) + (this.colorFilter == null ? 0 : this.colorFilter.hashCode());
    }
    ...
    public void update(PainterModifier node) {
        ...
        boolean intrinsicsChanged = node.getSizeToIntrinsics() != this.sizeToIntrinsics || (this.sizeToIntrinsics && !Size.m2775equalsimpl0(node.getPainter().mo3561getIntrinsicSizeNHjbRc(), this.painter.mo3561getIntrinsicSizeNHjbRc()));
