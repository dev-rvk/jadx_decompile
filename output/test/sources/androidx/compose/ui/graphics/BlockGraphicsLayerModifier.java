...
public final class BlockGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void invalidateLayerBlock() {
        NodeCoordinator wrapped = DelegatableNodeKt.m4299requireCoordinator64DMado(this, NodeKind.m4400constructorimpl(2)).getWrapped();
        if (wrapped != null) {
    ...
    public MeasureResult mo241measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.BlockGraphicsLayerModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
