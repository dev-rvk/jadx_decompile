...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo720createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        return new Outline.Rounded(RoundRectKt.m2762RoundRectZAM2FJo(SizeKt.m2800toRectuvyYCjk(size), CornerRadiusKt.CornerRadius$default(topStart, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(topEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomStart, 0.0f, 2, null)));
    }
    ...
    private final long m724toRadiusBz7bX_o(float $this$toRadius_u2dBz7bX_o) {
