...
public final class ChipElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5216boximpl(target), new ChipElevation$animateElevation$3(animatable, this, target, interaction, null), $composer, 64);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(-1373769818);
            ComposerKt.sourceInformation($composer, "1550@74861L52");
            EffectsKt.LaunchedEffect(Dp.m5216boximpl(target), new ChipElevation$animateElevation$2(animatable, target, null), $composer, 64);
            $composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipElevation) && Dp.m5223equalsimpl0(this.elevation, ((ChipElevation) other).elevation) && Dp.m5223equalsimpl0(this.pressedElevation, ((ChipElevation) other).pressedElevation) && Dp.m5223equalsimpl0(this.focusedElevation, ((ChipElevation) other).focusedElevation) && Dp.m5223equalsimpl0(this.hoveredElevation, ((ChipElevation) other).hoveredElevation) && Dp.m5223equalsimpl0(this.disabledElevation, ((ChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
