...
public final class PointerInputTestUtilKt {
    public static final PointerInputChange down(long id, long durationMillis, float x, float y) {
        return new PointerInputChange(PointerId.m4049constructorimpl(id), durationMillis, OffsetKt.Offset(x, y), true, 1.0f, durationMillis, OffsetKt.Offset(x, y), false, false, 0, 0L, 1536, (DefaultConstructorMarker) null);
    }
    ...
    public static final PointerInputChange moveBy(PointerInputChange $this$moveBy, long durationMillis, float dx, float dy) {
        ...
        return new PointerInputChange(id, $this$moveBy.getUptimeMillis() + durationMillis, OffsetKt.Offset(Offset.m2710getXimpl($this$moveBy.getPosition()) + dx, Offset.m2711getYimpl($this$moveBy.getPosition()) + dy), true, 1.0f, uptimeMillis, $this$moveBy.getPosition(), pressed, false, 0, 0L, 1536, (DefaultConstructorMarker) null);
    }
    ...
    public static final void m4118invokeOverAllPassesH0pRuoY(Function3<? super PointerEvent, ? super PointerEventPass, ? super IntSize, Unit> invokeOverAllPasses, PointerEvent pointerEvent, long size) {
        Intrinsics.checkNotNullParameter(invokeOverAllPasses, "$this$invokeOverAllPasses");
        Intrinsics.checkNotNullParameter(pointerEvent, "pointerEvent");
        m4122invokeOverPasseshUlJWOE(invokeOverAllPasses, pointerEvent, (List<? extends PointerEventPass>) CollectionsKt.listOf((Object[]) new PointerEventPass[]{PointerEventPass.Initial, PointerEventPass.Main, PointerEventPass.Final}), size);
    }
    ...
    public static final void m4120invokeOverPasshUlJWOE(Function3<? super PointerEvent, ? super PointerEventPass, ? super IntSize, Unit> invokeOverPass, PointerEvent pointerEvent, PointerEventPass pointerEventPass, long size) {
        ...
        m4122invokeOverPasseshUlJWOE(invokeOverPass, pointerEvent, (List<? extends PointerEventPass>) CollectionsKt.listOf(pointerEventPass), size);
    }
    ...
    public static final void m4123invokeOverPasseshUlJWOE(Function3<? super PointerEvent, ? super PointerEventPass, ? super IntSize, Unit> invokeOverPasses, PointerEvent pointerEvent, PointerEventPass[] pointerEventPasses, long size) {
        ...
        m4122invokeOverPasseshUlJWOE(invokeOverPasses, pointerEvent, (List<? extends PointerEventPass>) ArraysKt.toList(pointerEventPasses), size);
    }
    ...
    /* renamed from: invokeOverPasses-hUlJWOE, reason: not valid java name */
    public static final void m4122invokeOverPasseshUlJWOE(Function3<? super PointerEvent, ? super PointerEventPass, ? super IntSize, Unit> invokeOverPasses, PointerEvent pointerEvent, List<? extends PointerEventPass> pointerEventPasses, long size) {
        Intrinsics.checkNotNullParameter(invokeOverPasses, "$this$invokeOverPasses");
        Intrinsics.checkNotNullParameter(pointerEvent, "pointerEvent");
        Intrinsics.checkNotNullParameter(pointerEventPasses, "pointerEventPasses");
        ...
        for (int index$iv = 0; index$iv < size2; index$iv++) {
            ...
            invokeOverPasses.invoke(pointerEvent, it, IntSize.m5370boximpl(size));
        }
    }
}
