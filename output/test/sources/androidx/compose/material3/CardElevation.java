...
public final class CardElevation {
    ...
    public final State<Dp> tonalElevation$material3_release(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m5216boximpl(this.defaultElevation), null, 2, null);
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        EffectsKt.LaunchedEffect(Dp.m5216boximpl(target), new CardElevation$animateElevation$2(enabled, animatable, this, target, interaction, null), $composer, 64);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardElevation) && Dp.m5223equalsimpl0(this.defaultElevation, ((CardElevation) other).defaultElevation) && Dp.m5223equalsimpl0(this.pressedElevation, ((CardElevation) other).pressedElevation) && Dp.m5223equalsimpl0(this.focusedElevation, ((CardElevation) other).focusedElevation) && Dp.m5223equalsimpl0(this.hoveredElevation, ((CardElevation) other).hoveredElevation) && Dp.m5223equalsimpl0(this.disabledElevation, ((CardElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
