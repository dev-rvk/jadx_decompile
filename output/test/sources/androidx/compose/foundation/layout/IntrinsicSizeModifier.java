...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    long mo438calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default MeasureResult mo41measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long contentConstraints = mo438calculateContentConstraintsl58MMJ0(measure, measurable, constraints);
        final Placeable placeable = measurable.mo4186measureBRTryo0(getEnforceIncoming() ? ConstraintsKt.m5186constrainN9IONVI(constraints, contentConstraints) : contentConstraints);
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m4244placeRelative70tqf50$default(layout, Placeable.this, IntOffset.INSTANCE.m5346getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
