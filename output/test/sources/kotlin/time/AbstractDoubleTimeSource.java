...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo6930elapsedNowUwyO8pc() {
            return Duration.m6975minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo6933plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m6976plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo6932minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m6945equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m6972isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m7043getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m6975minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m6945equalsimpl0(startedAtDiff, Duration.m6993unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m7043getZEROUwyO8pc() : Duration.m6976plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m6945equalsimpl0(mo6932minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m7043getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m6968hashCodeimpl(Duration.m6976plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m6989toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m7043getZEROUwyO8pc(), null);
    }
}
