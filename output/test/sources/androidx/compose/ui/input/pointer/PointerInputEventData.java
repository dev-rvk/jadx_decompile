...
public final /* data */ class PointerInputEventData {
    ...
    public final PointerInputEventData m4080copygYeeOSc(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean issuesEnterExit, List<HistoricalChange> historical, long scrollDelta) {
    ...
    public boolean equals(Object other) {
        ...
        return PointerId.m4051equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m2707equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m2707equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m4139equalsimpl0(this.type, pointerInputEventData.type) && this.issuesEnterExit == pointerInputEventData.issuesEnterExit && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m2707equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public int hashCode() {
        int m4052hashCodeimpl = ((((((PointerId.m4052hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m2712hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m2712hashCodeimpl(this.position)) * 31;
        boolean z = this.down;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        int hashCode = (((((m4052hashCodeimpl + i) * 31) + Float.hashCode(this.pressure)) * 31) + PointerType.m4140hashCodeimpl(this.type)) * 31;
        boolean z2 = this.issuesEnterExit;
        return ((((hashCode + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.historical.hashCode()) * 31) + Offset.m2712hashCodeimpl(this.scrollDelta);
    }

    public String toString() {
        return "PointerInputEventData(id=" + ((Object) PointerId.m4053toStringimpl(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) Offset.m2718toStringimpl(this.positionOnScreen)) + ", position=" + ((Object) Offset.m2718toStringimpl(this.position)) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + ((Object) PointerType.m4141toStringimpl(this.type)) + ", issuesEnterExit=" + this.issuesEnterExit + ", historical=" + this.historical + ", scrollDelta=" + ((Object) Offset.m2718toStringimpl(this.scrollDelta)) + ')';
    }
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & 128) != 0 ? false : z2, (i2 & 256) != 0 ? new ArrayList() : list, (i2 & 512) != 0 ? Offset.INSTANCE.m2726getZeroF1C5BW0() : j5, null);
    }

    /* renamed from: getId-J3iCeTQ, reason: not valid java name */
    public final long m4081getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m4083getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m4082getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m4085getTypeT8wyACA() {
        return this.type;
    }
    ...
    public final long m4084getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }
}
