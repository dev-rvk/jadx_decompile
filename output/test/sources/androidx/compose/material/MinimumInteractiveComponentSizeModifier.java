...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default(measure, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.MinimumInteractiveComponentSizeModifier$measure$1
