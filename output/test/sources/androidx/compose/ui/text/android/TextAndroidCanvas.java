...
public final class TextAndroidCanvas extends Canvas {
    ...
    public boolean getClipBounds(Rect bounds) {
        ...
        boolean result = canvas.getClipBounds(bounds);
        if (result) {
