...
public final class SelectableChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m190BorderStrokecXLIe8U(selected ? this.selectedBorderWidth : this.borderWidth, color), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipBorder) && Color.m2950equalsimpl0(this.borderColor, ((SelectableChipBorder) other).borderColor) && Color.m2950equalsimpl0(this.selectedBorderColor, ((SelectableChipBorder) other).selectedBorderColor) && Color.m2950equalsimpl0(this.disabledBorderColor, ((SelectableChipBorder) other).disabledBorderColor) && Color.m2950equalsimpl0(this.disabledSelectedBorderColor, ((SelectableChipBorder) other).disabledSelectedBorderColor) && Dp.m5223equalsimpl0(this.borderWidth, ((SelectableChipBorder) other).borderWidth) && Dp.m5223equalsimpl0(this.selectedBorderWidth, ((SelectableChipBorder) other).selectedBorderWidth)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m2956hashCodeimpl(this.selectedBorderColor)) * 31) + Color.m2956hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m2956hashCodeimpl(this.disabledSelectedBorderColor)) * 31) + Dp.m5224hashCodeimpl(this.borderWidth)) * 31) + Dp.m5224hashCodeimpl(this.selectedBorderWidth);
    }
}
