...
public final class BlockRunner$cancel$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        long j;
        BlockRunner$cancel$1 blockRunner$cancel$1;
        ...
        coroutineLiveData = ((BlockRunner) blockRunner$cancel$1.this$0).liveData;
        if (!coroutineLiveData.hasActiveObservers()) {
            job = ((BlockRunner) blockRunner$cancel$1.this$0).runningJob;
            if (job != null) {
                Job.DefaultImpls.cancel$default(job, (CancellationException) null, 1, (Object) null);
            }
            ((BlockRunner) blockRunner$cancel$1.this$0).runningJob = null;
        }
