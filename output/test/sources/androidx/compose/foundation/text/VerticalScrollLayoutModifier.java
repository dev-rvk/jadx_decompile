...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo41measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        childConstraints = Constraints.m5164copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5176getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5174getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5175getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5173getMaxHeightimpl(constraints) : Integer.MAX_VALUE);
        final Placeable placeable = measurable.mo4186measureBRTryo0(childConstraints);
        final int height = Math.min(placeable.getHeight(), Constraints.m5173getMaxHeightimpl(constraints));
        return MeasureScope.layout$default(measure, placeable.getWidth(), height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Rect cursorRect = TextFieldScrollKt.access$getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, false, placeable.getWidth());
