...
interface SideCalculator {
    ...
    long mo512consumedOffsetsMKHz9U(long available);

    /* renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo513consumedVelocityQWom1Mo(long available, float remaining);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo512consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(Offset.m2710getXimpl(available), 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo513consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m5443getXimpl(available) - remaining, 0.0f);
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* renamed from: consumedOffsets-MK-Hz9U */
            public long mo512consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(0.0f, Offset.m2711getYimpl(available));
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo513consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m5444getYimpl(available) - remaining);
            }
        };
        ...
        public final SideCalculator m514chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            if (WindowInsetsSides.m565equalsimpl0(side, WindowInsetsSides.INSTANCE.m579getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m565equalsimpl0(side, WindowInsetsSides.INSTANCE.m582getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m565equalsimpl0(side, WindowInsetsSides.INSTANCE.m580getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m565equalsimpl0(side, WindowInsetsSides.INSTANCE.m576getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m565equalsimpl0(side, WindowInsetsSides.INSTANCE.m581getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            }
            if (!WindowInsetsSides.m565equalsimpl0(side, WindowInsetsSides.INSTANCE.m577getEndJoeWqyM())) {
