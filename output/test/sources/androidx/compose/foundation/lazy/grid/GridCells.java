...
@Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010 \n\u0002\u0010\b\n\u0002\u0018\u0002\n\u0002\b\u0006\bg\u0018\u00002\u00020\u0001:\u0003\b\t\nJ\"\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003*\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0004H&ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u000bÀ\u0006\u0001"}, d2 = {"Landroidx/compose/foundation/lazy/grid/GridCells;", "", "calculateCrossAxisCellSizes", "", "", "Landroidx/compose/ui/unit/Density;", "availableSize", "spacing", "Adaptive", "Fixed", "FixedSize", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
/* loaded from: classes.dex */
public interface GridCells {
    List<Integer> calculateCrossAxisCellSizes(Density density, int i, int i2);

    /* compiled from: LazyGridDsl.kt */
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0013\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\bH\u0096\u0002J\b\u0010\t\u001a\u00020\u0003H\u0016J\"\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00030\u000b*\u00020\f2\u0006\u0010\r\u001a\u00020\u00032\u0006\u0010\u000e\u001a\u00020\u0003H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"Landroidx/compose/foundation/lazy/grid/GridCells$Fixed;", "Landroidx/compose/foundation/lazy/grid/GridCells;", "count", "", "(I)V", "equals", "", "other", "", "hashCode", "calculateCrossAxisCellSizes", "", "Landroidx/compose/ui/unit/Density;", "availableSize", "spacing", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    public static final class Fixed implements GridCells {
        ...
        public Fixed(int count) {
            ...
            if (this.count > 0) {
                ...
                throw new IllegalArgumentException(("Provided count " + this.count + " should be larger than zero").toString());
            }
        }
    ...
    public static final class Adaptive implements GridCells {
        ...
        private Adaptive(float minSize) {
            ...
            if (Dp.m5217compareTo0680j_4(this.minSize, Dp.m5218constructorimpl((float) 0)) > 0) {
            } else {
                throw new IllegalArgumentException(("Provided min size " + ((Object) Dp.m5229toStringimpl(this.minSize)) + " should be larger than zero.").toString());
            }
        }
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            List<Integer> calculateCellsCrossAxisSizeImpl;
            Intrinsics.checkNotNullParameter($this$calculateCrossAxisCellSizes, "<this>");
            int count = Math.max((availableSize + spacing) / ($this$calculateCrossAxisCellSizes.mo323roundToPx0680j_4(this.minSize) + spacing), 1);
            calculateCellsCrossAxisSizeImpl = LazyGridDslKt.calculateCellsCrossAxisSizeImpl(availableSize, count, spacing);
            return calculateCellsCrossAxisSizeImpl;
        }

        public int hashCode() {
            return Dp.m5224hashCodeimpl(this.minSize);
        }

        public boolean equals(Object other) {
            return (other instanceof Adaptive) && Dp.m5223equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }
    }
    ...
    public static final class FixedSize implements GridCells {
        ...
        private FixedSize(float size) {
            this.size = size;
            if (Dp.m5217compareTo0680j_4(this.size, Dp.m5218constructorimpl((float) 0)) > 0) {
            } else {
                throw new IllegalArgumentException(("Provided size " + ((Object) Dp.m5229toStringimpl(this.size)) + " should be larger than zero.").toString());
            }
        }
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density $this$calculateCrossAxisCellSizes, int availableSize, int spacing) {
            Intrinsics.checkNotNullParameter($this$calculateCrossAxisCellSizes, "<this>");
            int cellSize = $this$calculateCrossAxisCellSizes.mo323roundToPx0680j_4(this.size);
            int i = 0;
        ...
        public int hashCode() {
            return Dp.m5224hashCodeimpl(this.size);
        }

        public boolean equals(Object other) {
            return (other instanceof FixedSize) && Dp.m5223equalsimpl0(this.size, ((FixedSize) other).size);
        }
    }
}
