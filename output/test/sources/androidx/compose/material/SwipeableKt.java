...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableState(final T initialValue, final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> function1, Composer $composer, int $changed, int i) {
        ...
        SwipeableState<T> swipeableState = (SwipeableState) RememberSaveableKt.m2596rememberSaveable(new Object[0], (Saver) SwipeableState.INSTANCE.Saver(animationSpec, function1), (String) null, (Function0) new Function0<SwipeableState<T>>() { // from class: androidx.compose.material.SwipeableKt$rememberSwipeableState$2
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            this.$state.setVelocityThreshold$material_release($this$invokeSuspend_u24lambda_u240.mo329toPx0680j_4(this.$velocityThreshold));
                            this.label = 1;
