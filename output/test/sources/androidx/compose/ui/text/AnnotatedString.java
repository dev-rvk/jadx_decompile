...
public final class AnnotatedString implements CharSequence {
    ...
    */
    ...
    public final AnnotatedString m4601subSequence5zctL8(long range) {
        return subSequence(TextRange.m4724getMinimpl(range), TextRange.m4723getMaximpl(range));
    }
    ...
    */
    ...
    public static final class Builder implements Appendable {
        ...
        public final void append(AnnotatedString text, int start, int end) {
            ...
            List $this$fastForEach$iv = AnnotatedStringKt.access$getLocalSpanStyles(text, start, end);
            if ($this$fastForEach$iv != null) {
                int size = $this$fastForEach$iv.size();
                for (int index$iv = 0; index$iv < size; index$iv++) {
                    Object item$iv = $this$fastForEach$iv.get(index$iv);
            ...
            List $this$fastForEach$iv2 = AnnotatedStringKt.access$getLocalParagraphStyles(text, start, end);
            if ($this$fastForEach$iv2 != null) {
                int size2 = $this$fastForEach$iv2.size();
                for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
                    Object item$iv2 = $this$fastForEach$iv2.get(index$iv2);
            ...
            List $this$fastForEach$iv3 = AnnotatedStringKt.access$getLocalAnnotations(text, start, end);
            if ($this$fastForEach$iv3 == null) {
                return;
            }
            int index$iv3 = 0;
