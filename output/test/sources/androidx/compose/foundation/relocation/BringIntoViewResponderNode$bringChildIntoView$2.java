...
final class BringIntoViewResponderNode$bringChildIntoView$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (this.this$0.getResponder().bringChildIntoView(new C00141(this.this$0, this.$childCoordinates, this.$boundsProvider), this) != coroutine_suspended) {
                        break;
                    } else {
        ...
        public /* synthetic */ class C00141 extends FunctionReferenceImpl implements Function0<Rect> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00141(BringIntoViewResponderNode bringIntoViewResponderNode, LayoutCoordinates layoutCoordinates, Function0<Rect> function0) {
