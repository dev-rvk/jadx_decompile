...
public interface Selectable {
    ...
    long mo879getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle);
    ...
    long mo880getRangeOfLineContainingjx7JFs(int offset);
    ...
    Pair<Selection, Boolean> mo881updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, LayoutCoordinates containerLayoutCoordinates, SelectionAdjustment adjustment, Selection previousSelection);

    /* renamed from: updateSelection-qCDeeow$default, reason: not valid java name */
    static /* synthetic */ Pair m887updateSelectionqCDeeow$default(Selectable selectable, long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i, Object obj) {
        boolean z2;
        ...
        return selectable.mo881updateSelectionqCDeeow(j, j2, offset, z2, layoutCoordinates, selectionAdjustment, selection2);
    }
}
