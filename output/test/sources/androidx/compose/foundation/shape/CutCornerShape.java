...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo720createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (((topStart + topEnd) + bottomStart) + bottomEnd == 0.0f) {
            return new Outline.Rectangle(SizeKt.m2800toRectuvyYCjk(size));
        }
        ...
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2779getWidthimpl(size) - cornerSize2, 0.0f);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2779getWidthimpl(size), cornerSize2);
        float cornerSize3 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2779getWidthimpl(size), Size.m2776getHeightimpl(size) - cornerSize3);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2779getWidthimpl(size) - cornerSize3, Size.m2776getHeightimpl(size));
        float cornerSize4 = layoutDirection == LayoutDirection.Ltr ? bottomStart : bottomEnd;
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(cornerSize4, Size.m2776getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(0.0f, Size.m2776getHeightimpl(size) - cornerSize4);
