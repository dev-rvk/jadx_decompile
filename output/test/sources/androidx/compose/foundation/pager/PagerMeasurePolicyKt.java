...
public final class PagerMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> m702rememberPagerMeasurePolicyBxUkNYg(final Function0<PagerLazyLayoutItemProvider> itemProviderLambda, final PagerState state, final PaddingValues contentPadding, final boolean reverseLayout, final Orientation orientation, final int beyondBoundsPageCount, final float pageSpacing, final PageSize pageSize, final Alignment.Horizontal horizontalAlignment, final Alignment.Vertical verticalAlignment, final Function0<Integer> pageCount, Composer $composer, int $changed, int $changed1) {
        ...
        Object[] keys$iv = {contentPadding, Dp.m5216boximpl(pageSpacing), pageSize, state, contentPadding, Boolean.valueOf(reverseLayout), orientation, horizontalAlignment, verticalAlignment, pageCount};
        ...
        if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = new Function2<LazyLayoutMeasureScope, Constraints, PagerMeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ PagerMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m703invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final PagerMeasureResult m703invoke0kLqBqw(final LazyLayoutMeasureScope $this$null, final long containerConstraints) {
                    int i;
                    int i2;
                    int i3;
                    ...
                    if (isVertical) {
                        i = $this$null.mo323roundToPx0680j_4(contentPadding.mo435calculateLeftPaddingu2uoSUM($this$null.getLayoutDirection()));
                    } else {
                        i = $this$null.mo323roundToPx0680j_4(PaddingKt.calculateStartPadding(contentPadding, $this$null.getLayoutDirection()));
                    }
                    int startPadding = i;
                    if (isVertical) {
                        i2 = $this$null.mo323roundToPx0680j_4(contentPadding.mo436calculateRightPaddingu2uoSUM($this$null.getLayoutDirection()));
                    } else {
                        i2 = $this$null.mo323roundToPx0680j_4(PaddingKt.calculateEndPadding(contentPadding, $this$null.getLayoutDirection()));
                    }
                    int endPadding = i2;
                    ...
                    int spaceBetweenPages = $this$null.mo323roundToPx0680j_4(pageSpacing);
                    if (isVertical) {
                    ...
                    if (Orientation.this == Orientation.Vertical) {
                        i4 = Constraints.m5174getMaxWidthimpl(contentConstraints);
                    } else {
                        i4 = calculateMainAxisPageSize;
                    }
                    if (Orientation.this != Orientation.Vertical) {
                        i5 = Constraints.m5173getMaxHeightimpl(contentConstraints);
                    } else {
                        i5 = calculateMainAxisPageSize;
                    }
                    pagerState.m706setPremeasureConstraintsBRTryo0$foundation_release(ConstraintsKt.Constraints$default(0, i4, 0, i5, 5, null));
