...
public abstract class AbstractClickablePointerInputNode extends DelegatingNode implements ModifierLocalModifierNode, CompositionLocalConsumerModifierNode, PointerInputModifierNode {
    ...
    public final Object m151handlePressInteractiond4ec7I(PressGestureScope $this$handlePressInteraction_u2dd_u2d4ec7I, long offset, Continuation<? super Unit> continuation) {
        Object m192access$handlePressInteractionEPk0efs;
        MutableInteractionSource interactionSource = this.interactionSource;
        return (interactionSource == null || (m192access$handlePressInteractionEPk0efs = ClickableKt.m192access$handlePressInteractionEPk0efs($this$handlePressInteraction_u2dd_u2d4ec7I, offset, interactionSource, this.interactionData, this.delayPressInteraction, continuation)) != IntrinsicsKt.getCOROUTINE_SUSPENDED()) ? Unit.INSTANCE : m192access$handlePressInteractionEPk0efs;
    }
