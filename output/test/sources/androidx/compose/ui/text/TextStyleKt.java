...
public final class TextStyleKt {
    ...
    public static final int m4758resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (textDirection == null ? false : TextDirection.m5099equalsimpl0(textDirection.getValue(), TextDirection.INSTANCE.m5103getContents_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m5104getContentOrLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m5105getContentOrRtls_7Xco();
                default:
        ...
        if (textDirection == null) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m5106getLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m5107getRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
