...
public final class DepthSortedSet {
    ...
    private final Comparator<LayoutNode> DepthComparator = new Comparator<LayoutNode>() { // from class: androidx.compose.ui.node.DepthSortedSet$DepthComparator$1
    ...
    private final TreeSet<LayoutNode> set = new TreeSet<>(this.DepthComparator);
