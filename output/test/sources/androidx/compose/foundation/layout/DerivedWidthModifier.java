...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        childConstraints = Constraints.m5164copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5176getMinWidthimpl(constraints) : width, (r12 & 2) != 0 ? Constraints.m5174getMaxWidthimpl(constraints) : width, (r12 & 4) != 0 ? Constraints.m5175getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5173getMaxHeightimpl(constraints) : 0);
        final Placeable placeable = measurable.mo4186measureBRTryo0(childConstraints);
        return MeasureScope.layout$default(measure, width, placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$2
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof DerivedWidthModifier) {
            return Intrinsics.areEqual(this.insets, ((DerivedWidthModifier) other).insets) && Intrinsics.areEqual(this.widthCalc, ((DerivedWidthModifier) other).widthCalc);
        }
        return false;
    }
