...
public final class LazyLayoutPrefetchState {
    ...
    public interface Prefetcher {
        ...
        PrefetchHandle mo644schedulePrefetch0kLqBqw(int index, long constraints);
    }
    ...
    /* renamed from: schedulePrefetch-0kLqBqw, reason: not valid java name */
    public final PrefetchHandle m643schedulePrefetch0kLqBqw(int index, long constraints) {
        PrefetchHandle mo644schedulePrefetch0kLqBqw;
        Prefetcher prefetcher = this.prefetcher;
        return (prefetcher == null || (mo644schedulePrefetch0kLqBqw = prefetcher.mo644schedulePrefetch0kLqBqw(index, constraints)) == null) ? DummyHandle.INSTANCE : mo644schedulePrefetch0kLqBqw;
    }
}
