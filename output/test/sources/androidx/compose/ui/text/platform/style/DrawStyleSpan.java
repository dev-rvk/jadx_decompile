...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
        ...
        if (textPaint != null) {
            ...
            if (!Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                if (drawStyle instanceof Stroke) {
                    ...
                    textPaint.setStrokeJoin(m4980toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                    textPaint.setStrokeCap(m4979toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m4980toAndroidJoinWw9F2mQ(int $this$toAndroidJoin_u2dWw9F2mQ) {
        return StrokeJoin.m3301equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3306getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m3301equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3307getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m3301equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3305getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m4979toAndroidCapBeK7IIE(int $this$toAndroidCap_u2dBeK7IIE) {
        return StrokeCap.m3291equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3295getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m3291equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3296getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m3291equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3297getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
