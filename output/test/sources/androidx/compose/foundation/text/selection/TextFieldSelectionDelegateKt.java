...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m940getTextFieldSelectionbb3KNj8(TextLayoutResult textLayoutResult, int rawStartOffset, int rawEndOffset, TextRange previousSelection, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        if (textLayoutResult != null) {
            ...
            return adjustment.mo889adjustZXO7KMw(textLayoutResult, textRange, -1, isStartHandle, previousSelection);
        }
