...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean m872updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        ...
        if (textChanged || layoutChanged) {
            getLayoutCache().m859updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
    ...
    public MeasureResult mo241measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        boolean didChangeLayout = layoutCache.m857layoutWithConstraintsK40F9xA(constraints, measure.getLayoutDirection());
        ...
        final Placeable placeable = measurable.mo4186measureBRTryo0(Constraints.INSTANCE.m5182fixedJhjzzOo(IntSize.m5378getWidthimpl(layoutSize), IntSize.m5377getHeightimpl(layoutSize)));
        int m5378getWidthimpl = IntSize.m5378getWidthimpl(layoutSize);
        int m5377getHeightimpl = IntSize.m5377getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(m5378getWidthimpl, m5377getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
