...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo720createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2779getWidthimpl(size) - topEnd, 0.0f);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2779getWidthimpl(size), topEnd);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2779getWidthimpl(size), Size.m2776getHeightimpl(size) - bottomEnd);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2779getWidthimpl(size) - bottomEnd, Size.m2776getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(bottomStart, Size.m2776getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(0.0f, Size.m2776getHeightimpl(size) - bottomStart);
