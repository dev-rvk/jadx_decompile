...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5218constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m5218constructorimpl((float) 24.0d);
    ...
    public final float m2322getContainerSizeD9Ej5fM() {
    ...
    public final float m2323getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2324getUnselectedOutlineWidthD9Ej5fM() {
