...
public interface SendChannel<E> {
    ...
    Object mo7116trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo7116trySendJP2dKIU(e);
            if (ChannelResult.m7136isSuccessimpl(result)) {
                return true;
            }
            Throwable m7130exceptionOrNullimpl = ChannelResult.m7130exceptionOrNullimpl(result);
