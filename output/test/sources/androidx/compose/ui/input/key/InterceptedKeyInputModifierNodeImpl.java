...
final class InterceptedKeyInputModifierNodeImpl extends Modifier.Node implements SoftKeyboardInterceptionModifierNode {
    ...
    public boolean mo3622onInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event) {
    ...
    public boolean mo3623onPreInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
