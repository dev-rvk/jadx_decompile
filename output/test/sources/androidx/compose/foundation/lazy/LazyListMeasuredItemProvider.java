...
public abstract class LazyListMeasuredItemProvider {
    ...
    private LazyListMeasuredItemProvider(long constraints, boolean isVertical, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, isVertical ? Constraints.m5174getMaxWidthimpl(constraints) : Integer.MAX_VALUE, 0, isVertical ? Integer.MAX_VALUE : Constraints.m5173getMaxHeightimpl(constraints), 5, null);
    }
    ...
    public final LazyListMeasuredItem getAndMeasure(int index) {
        ...
        List placeables = this.measureScope.mo642measure0kLqBqw(index, this.childConstraints);
