...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m932isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo763mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }
