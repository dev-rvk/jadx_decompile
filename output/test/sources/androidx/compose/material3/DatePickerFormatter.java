...
public final class DatePickerFormatter {
    ...
    public boolean equals(Object other) {
        return (other instanceof DatePickerFormatter) && Intrinsics.areEqual(this.yearSelectionSkeleton, ((DatePickerFormatter) other).yearSelectionSkeleton) && Intrinsics.areEqual(this.selectedDateSkeleton, ((DatePickerFormatter) other).selectedDateSkeleton) && Intrinsics.areEqual(this.selectedDateDescriptionSkeleton, ((DatePickerFormatter) other).selectedDateDescriptionSkeleton);
    }
