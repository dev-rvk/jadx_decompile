...
public final class KeyboardOptions {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m4911getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m4937getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m4884getDefaulteUduSuo() : i3, null);
    }
    ...
    public static /* synthetic */ KeyboardOptions m766copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m767copy3m2b7yw(i, z, i2, i3);
    }

    /* renamed from: copy-3m2b7yw, reason: not valid java name */
    public final KeyboardOptions m767copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof KeyboardOptions) && KeyboardCapitalization.m4902equalsimpl0(this.capitalization, ((KeyboardOptions) other).capitalization) && this.autoCorrect == ((KeyboardOptions) other).autoCorrect && KeyboardType.m4917equalsimpl0(this.keyboardType, ((KeyboardOptions) other).keyboardType) && ImeAction.m4872equalsimpl0(this.imeAction, ((KeyboardOptions) other).imeAction);
    }

    public int hashCode() {
        int result = KeyboardCapitalization.m4903hashCodeimpl(this.capitalization);
        return (((((result * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4918hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4873hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m4904toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4919toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4874toStringimpl(this.imeAction)) + ')';
    }
}
