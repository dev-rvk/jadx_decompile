...
public final class UnsignedKt {
    ...
    public static final int m5966uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m5710constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m5967uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m5710constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m5968ulongDivideeb3DHEI(long v1, long v2) {
        int compare;
        int compare2;
        if (v2 < 0) {
            compare2 = Long.compare(v1 ^ Long.MIN_VALUE, v2 ^ Long.MIN_VALUE);
            return ULong.m5789constructorimpl(compare2 >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m5789constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        compare = Long.compare(ULong.m5789constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m5789constructorimpl(v2) ^ Long.MIN_VALUE);
        return ULong.m5789constructorimpl((compare < 0 ? 0 : 1) + quotient);
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m5969ulongRemaindereb3DHEI(long v1, long v2) {
        int compare;
        int compare2;
        long j = 0;
        if (v2 < 0) {
        ...
        return ULong.m5789constructorimpl(rem - j);
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= 2.147483647E9d ? UInt.m5710constructorimpl((int) v) : UInt.m5710constructorimpl(UInt.m5710constructorimpl((int) (v - Integer.MAX_VALUE)) + UInt.m5710constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        return v < 9.223372036854776E18d ? ULong.m5789constructorimpl((long) v) : ULong.m5789constructorimpl(ULong.m5789constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
