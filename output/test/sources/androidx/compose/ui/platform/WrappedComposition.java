...
public final class WrappedComposition implements Composition, LifecycleEventObserver {
    ...
    public WrappedComposition(AndroidComposeView owner, Composition original) {
        ...
        this.lastContent = ComposableSingletons$Wrapper_androidKt.INSTANCE.m4497getLambda1$ui_release();
    }
                        ...
                        original.setContent(ComposableLambdaKt.composableLambdaInstance(-2000640158, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.WrappedComposition$setContent$1.1
                            ...
                            public final void invoke(Composer $composer, int $changed) {
                                ...
                                if (($changed & 11) != 2 || !$composer.getSkipping()) {
                                    ...
                                    EffectsKt.LaunchedEffect(WrappedComposition.this.getOwner(), new C00611(WrappedComposition.this, null), $composer, 72);
                            ...
                            public static final class C00611 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                ...
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                C00611(WrappedComposition wrappedComposition, Continuation<? super C00611> continuation) {
