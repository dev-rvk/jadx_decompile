    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (AnchoredDraggableKt.snapTo(this.$state, AnchoredDraggableKt.closestAnchor$default(this.$newAnchors, this.$state.requireOffset(), false, 2, null), this) != coroutine_suspended) {
                    break;
                } else {
