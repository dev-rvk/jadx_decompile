...
public final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        m1278drawRipples4WTKRHQ($this$drawIndication, color);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        Offset origin = this.bounded ? Offset.m2699boximpl(interaction.getPressPosition()) : null;
    ...
    private final void m1278drawRipples4WTKRHQ(DrawScope $this$drawRipples_u2d4WTKRHQ, long color) {
        ...
        for (Map.Entry element$iv : $this$forEach$iv.entrySet()) {
            ...
            if (!(alpha == 0.0f)) {
                m2947copywmQWz5c = Color.m2947copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2951getAlphaimpl(color) : alpha, (r12 & 2) != 0 ? Color.m2955getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2954getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2952getBlueimpl(color) : 0.0f);
                ripple.m1279draw4WTKRHQ($this$drawRipples_u2d4WTKRHQ, m2947copywmQWz5c);
            }
        }
    }
