...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo7173scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo7173scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    public void mo7172dispatch(CoroutineContext context, Runnable block) {
        ...
        if (runningWorkers$FU.get(this) < this.parallelism && tryAllocateWorker() && (task$iv = obtainTaskOrDeallocateWorker()) != null) {
            ...
            this.dispatcher.mo7172dispatch(this, worker);
        }
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (fairnessCounter >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo7172dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
