...
public final class CardColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardColors) && Color.m2950equalsimpl0(this.containerColor, ((CardColors) other).containerColor) && Color.m2950equalsimpl0(this.contentColor, ((CardColors) other).contentColor) && Color.m2950equalsimpl0(this.disabledContainerColor, ((CardColors) other).disabledContainerColor) && Color.m2950equalsimpl0(this.disabledContentColor, ((CardColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
