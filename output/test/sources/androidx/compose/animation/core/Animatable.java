...
public final class Animatable<T, V extends AnimationVector> {
    ...
    public Animatable(T t, TwoWayConverter<T, V> typeConverter, T t2, String label) {
        ...
        this.negativeInfinityBounds = createVector(t, Float.NEGATIVE_INFINITY);
        this.positiveInfinityBounds = createVector(t, Float.POSITIVE_INFINITY);
