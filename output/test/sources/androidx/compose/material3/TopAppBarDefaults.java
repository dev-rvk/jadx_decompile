...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m1996topAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
        ...
        long scrolledContainerColor2 = (i & 2) != 0 ? ColorSchemeKt.m1412applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme($composer, 6), containerColor2, TopAppBarSmallTokens.INSTANCE.m2510getOnScrollContainerElevationD9Ej5fM()) : scrolledContainerColor;
    ...
    public final TopAppBarColors m1995smallTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
        ...
        TopAppBarColors m1996topAppBarColorszjMxDiM = m1996topAppBarColorszjMxDiM(containerColor2, scrolledContainerColor2, navigationIconContentColor2, titleContentColor2, actionIconContentColor2, $composer, ($changed & 14) | ($changed & 112) | ($changed & 896) | ($changed & 7168) | (57344 & $changed) | (458752 & $changed), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m1996topAppBarColorszjMxDiM;
    }
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets m557onlybOOhFvg = WindowInsetsKt.m557onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, $composer, 8), WindowInsetsSides.m568plusgK_yJZ4(WindowInsetsSides.INSTANCE.m578getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m582getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final TopAppBarColors m1992centerAlignedTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
    ...
    public final TopAppBarColors m1994mediumTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
    ...
    public final TopAppBarColors m1993largeTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
