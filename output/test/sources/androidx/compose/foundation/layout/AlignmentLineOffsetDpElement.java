...
public final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float before, float after, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if ((this.before >= 0.0f || Dp.m5223equalsimpl0(this.before, Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM())) && (this.after >= 0.0f || Dp.m5223equalsimpl0(this.after, Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM()))) {
        } else {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m378setBefore0680j_4(this.before);
        node.m377setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && Dp.m5223equalsimpl0(this.before, otherModifier.before) && Dp.m5223equalsimpl0(this.after, otherModifier.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.alignmentLine.hashCode();
        return (((result * 31) + Dp.m5224hashCodeimpl(this.before)) * 31) + Dp.m5224hashCodeimpl(this.after);
    }
}
