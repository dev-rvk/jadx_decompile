...
public final /* data */ class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m4860copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        return typefaceRequest.m4863copye1PVR60(fontFamily, fontWeight2, i4, i5, obj);
    }
    ...
    public final TypefaceRequest m4863copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis, Object resourceLoaderCacheKey) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.fontFamily, typefaceRequest.fontFamily) && Intrinsics.areEqual(this.fontWeight, typefaceRequest.fontWeight) && FontStyle.m4821equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m4830equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && Intrinsics.areEqual(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
    }

    public int hashCode() {
        return ((((((((this.fontFamily == null ? 0 : this.fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m4822hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m4831hashCodeimpl(this.fontSynthesis)) * 31) + (this.resourceLoaderCacheKey != null ? this.resourceLoaderCacheKey.hashCode() : 0);
    }

    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m4823toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m4834toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
