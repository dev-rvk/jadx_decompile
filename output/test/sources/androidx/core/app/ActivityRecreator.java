...
public final class ActivityRecreator {
    ...
    public static boolean recreate(Activity activity) {
        ...
        final LifecycleCheckCallbacks callbacks = null;
        ...
        try {
            ...
            final LifecycleCheckCallbacks callbacks2 = new LifecycleCheckCallbacks(activity);
            application.registerActivityLifecycleCallbacks(callbacks2);
