...
public final /* data */ class TransitionData {
    ...
    public int hashCode() {
        return ((((((this.fade == null ? 0 : this.fade.hashCode()) * 31) + (this.slide == null ? 0 : this.slide.hashCode())) * 31) + (this.changeSize == null ? 0 : this.changeSize.hashCode())) * 31) + (this.scale != null ? this.scale.hashCode() : 0);
    }
