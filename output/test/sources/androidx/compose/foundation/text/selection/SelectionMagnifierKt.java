...
public final class SelectionMagnifierKt {
    ...
    private static final TwoWayConverter<Offset, AnimationVector2D> UnspecifiedSafeOffsetVectorConverter = VectorConvertersKt.TwoWayConverter(new Function1<Offset, AnimationVector2D>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$UnspecifiedSafeOffsetVectorConverter$1
        ...
        public /* bridge */ /* synthetic */ AnimationVector2D invoke(Offset offset) {
            return m899invokek4lQ0M(offset.getPackedValue());
        }

        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final AnimationVector2D m899invokek4lQ0M(long it) {
        ...
        public /* bridge */ /* synthetic */ Offset invoke(AnimationVector2D animationVector2D) {
            return Offset.m2699boximpl(m900invoketuRUvjQ(animationVector2D));
        }

        /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m900invoketuRUvjQ(AnimationVector2D it) {
    ...
    private static final SpringSpec<Offset> MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m2699boximpl(OffsetDisplacementThreshold), 3, null);
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer $composer, int $changed) {
        ...
        if (it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
            value$iv$iv2 = new Animatable(Offset.m2699boximpl(rememberAnimatedMagnifierPosition$lambda$1(targetValue$delegate)), UnspecifiedSafeOffsetVectorConverter, Offset.m2699boximpl(OffsetDisplacementThreshold), null, 8, null);
