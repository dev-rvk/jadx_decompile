...
public final /* data */ class FixedThreshold implements ThresholdConfig {
    ...
    public static /* synthetic */ FixedThreshold m1109copy0680j_4$default(FixedThreshold fixedThreshold, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = fixedThreshold.offset;
        }
        return fixedThreshold.m1110copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4, reason: not valid java name */
    public final FixedThreshold m1110copy0680j_4(float offset) {
