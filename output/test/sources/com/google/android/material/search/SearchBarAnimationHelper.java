...
public class SearchBarAnimationHelper {
    ...
    public void startExpandAnimation(final SearchBar searchBar, final View expandedView, final AppBarLayout appBarLayout, final boolean skipAnimation) {
        ...
        expandedView.post(new Runnable() { // from class: com.google.android.material.search.SearchBarAnimationHelper$$ExternalSyntheticLambda3
            ...
            public final void run() {
                SearchBarAnimationHelper.this.m5574x1b96b119(searchBar, expandedView, appBarLayout, skipAnimation);
            }
        });
    }
    ...
    public /* synthetic */ void m5574x1b96b119(SearchBar searchBar, View expandedView, AppBarLayout appBarLayout, boolean skipAnimation) {
