...
public interface RippleTheme {
    ...
    long mo1121defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1288defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            float contentLuminance = ColorKt.m3001luminance8_81llA(contentColor);
            if (!lightTheme && contentLuminance < 0.5d) {
                return Color.INSTANCE.m2986getWhite0d7_KjU();
            }
            return contentColor;
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc, reason: not valid java name */
        public final RippleAlpha m1287defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            ...
            if (ColorKt.m3001luminance8_81llA(contentColor) > 0.5d) {
