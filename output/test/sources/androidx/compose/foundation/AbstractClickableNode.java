...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.INSTANCE.m2726getZeroF1C5BW0();
        ...
        public final void m150setCentreOffsetk4lQ0M(long j) {
            this.centreOffset = j;
        }
    }
    ...
    public static /* synthetic */ void m144updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        Role role2;
        if (obj != null) {
        ...
        abstractClickableNode.m148updateCommonXHw0xAI(mutableInteractionSource, z, str, role2, function0);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: updateCommon-XHw0xAI, reason: not valid java name */
    public final void m148updateCommonXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
    ...
    public void mo146onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        getClickablePointerInputNode().mo146onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean mo145onKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        if (this.enabled && Clickable_androidKt.m211isPressZmokQxo(event)) {
            if (this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m3624boximpl(KeyEvent_androidKt.m3935getKeyZmokQxo(event)))) {
                return false;
            }
            PressInteraction.Press press = new PressInteraction.Press(this.interactionData.getCentreOffset(), null);
            this.interactionData.getCurrentKeyPressInteractions().put(Key.m3624boximpl(KeyEvent_androidKt.m3935getKeyZmokQxo(event)), press);
        ...
        if (!this.enabled || !Clickable_androidKt.m209isClickZmokQxo(event)) {
            return false;
        }
        PressInteraction.Press it = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3624boximpl(KeyEvent_androidKt.m3935getKeyZmokQxo(event)));
        if (it != null) {
    ...
    public boolean mo147onPreKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        return false;
    }
}
