...
public interface LookaheadScope {
    ...
    default long m4209localLookaheadPositionOfdBAh8RU(LayoutCoordinates localLookaheadPositionOf, LayoutCoordinates coordinates) {
        Intrinsics.checkNotNullParameter(localLookaheadPositionOf, "$this$localLookaheadPositionOf");
        Intrinsics.checkNotNullParameter(coordinates, "coordinates");
        return toLookaheadCoordinates(localLookaheadPositionOf).mo4194localPositionOfR5De75A(toLookaheadCoordinates(coordinates), Offset.INSTANCE.m2726getZeroF1C5BW0());
    }
    ...
    default Modifier intermediateLayout(Modifier $this$intermediateLayout, final Function4<? super MeasureScope, ? super Measurable, ? super Constraints, ? super IntSize, ? extends MeasureResult> measure) {
        ...
        return LookaheadScopeKt.intermediateLayout($this$intermediateLayout, new Function3<IntermediateMeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.ui.layout.LookaheadScope$intermediateLayout$1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(IntermediateMeasureScope intermediateMeasureScope, Measurable measurable, Constraints constraints) {
                return m4210invoke3p2s80s(intermediateMeasureScope, measurable, constraints.getValue());
            }

            /* renamed from: invoke-3p2s80s, reason: not valid java name */
            public final MeasureResult m4210invoke3p2s80s(IntermediateMeasureScope intermediateLayout, Measurable measurable, long constraints) {
                Intrinsics.checkNotNullParameter(intermediateLayout, "$this$intermediateLayout");
                Intrinsics.checkNotNullParameter(measurable, "measurable");
                return measure.invoke(intermediateLayout, measurable, Constraints.m5162boximpl(constraints), IntSize.m5370boximpl(intermediateLayout.mo4189getLookaheadSizeYbymL2g()));
            }
        });
    }
}
