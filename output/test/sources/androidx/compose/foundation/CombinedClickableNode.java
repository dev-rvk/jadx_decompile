...
final class CombinedClickableNode extends AbstractClickableNode {
    ...
    private CombinedClickableNode(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> function0, Function0<Unit> function02) {
        ...
        this.clickableSemanticsNode = (ClickableSemanticsNode) delegate(new ClickableSemanticsNode(enabled, onClickLabel, role, onClick, onLongClickLabel, this.onLongClick, null));
    ...
    public final void m213updatecJG_KMw(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick, Function0<Unit> onDoubleClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        ...
        m148updateCommonXHw0xAI(interactionSource, enabled, onClickLabel, role, onClick);
        getClickableSemanticsNode().m208updateUMe6uN4(enabled, onClickLabel, role, onClick, onLongClickLabel, onLongClick);
