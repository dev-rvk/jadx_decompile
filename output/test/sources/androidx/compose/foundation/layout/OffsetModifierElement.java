...
final class OffsetModifierElement extends ModifierNodeElement<OffsetNode> {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5223equalsimpl0(this.x, otherModifierElement.x) && Dp.m5223equalsimpl0(this.y, otherModifierElement.y) && this.rtlAware == otherModifierElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m5224hashCodeimpl(this.x);
        return (((result * 31) + Dp.m5224hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m5229toStringimpl(this.x)) + ", y=" + ((Object) Dp.m5229toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
