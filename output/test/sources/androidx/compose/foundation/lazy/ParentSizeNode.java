...
public final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo241measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int height = i2;
        long childConstraints = ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : Constraints.m5176getMinWidthimpl(constraints), width != Integer.MAX_VALUE ? width : Constraints.m5174getMaxWidthimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m5175getMinHeightimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m5173getMaxHeightimpl(constraints));
        final Placeable placeable = measurable.mo4186measureBRTryo0(childConstraints);
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
