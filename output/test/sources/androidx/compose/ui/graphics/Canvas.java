...
public interface Canvas {
    ...
    void mo2807drawCircle9KIMszo(long center, float radius, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo2808drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo2809drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo2810drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo2811drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo2812drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo2813drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m2927clipRectmtrdDE(Canvas $this, Rect rect, int clipOp) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            Canvas.super.m2924clipRectmtrdDE(rect, clipOp);
        }
    ...
    static /* synthetic */ void m2922clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-mtrdD-E");
        }
        if ((i2 & 2) != 0) {
            i = ClipOp.INSTANCE.m2938getIntersectrtfAjoo();
        }
        canvas.m2924clipRectmtrdDE(rect, i);
    }

    /* renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m2924clipRectmtrdDE(Rect rect, int clipOp) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        mo2805clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m2921clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        int i3;
        if (obj != null) {
        ...
        if ((i2 & 16) == 0) {
            ...
            i3 = ClipOp.INSTANCE.m2938getIntersectrtfAjoo();
        }
        canvas.mo2805clipRectN_I0leg(f, f2, f3, f4, i3);
    }

    /* renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m2920clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo2804clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m2923drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long m5346getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m5346getZeronOccac() : j;
        long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
        canvas.mo2809drawImageRectHPBpro0(imageBitmap, m5346getZeronOccac, IntSize, (i & 8) != 0 ? IntOffset.INSTANCE.m5346getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
    }
}
