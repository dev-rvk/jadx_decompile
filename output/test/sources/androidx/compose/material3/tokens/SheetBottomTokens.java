...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m5218constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m5218constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m2136getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m2136getLevel1D9Ej5fM();
    ...
    public final float m2427getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m2428getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m2429getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2430getDockedStandardContainerElevationD9Ej5fM() {
