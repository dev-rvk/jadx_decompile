    ...
    public static final <X, Y> LiveData<Y> switchMap(LiveData<X> liveData, final Function1<X, LiveData<Y>> transform) {
        ...
        if (liveData.isInitialized()) {
            ...
            if (initialLiveData != null && initialLiveData.isInitialized()) {
                mediatorLiveData = new MediatorLiveData(initialLiveData.getValue());
            } else {
        ...
        final MediatorLiveData result = mediatorLiveData;
        result.addSource(liveData, new Transformations$sam$androidx_lifecycle_Observer$0(new Function1<X, Unit>() { // from class: androidx.lifecycle.Transformations$switchMap$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(X x) {
                ?? r0 = (LiveData) transform.invoke(x);
                if (liveData2.element != r0) {
                    if (liveData2.element != 0) {
                        MediatorLiveData<Y> mediatorLiveData2 = result;
                        T t = liveData2.element;
                        Intrinsics.checkNotNull(t);
                        mediatorLiveData2.removeSource((LiveData) t);
                    }
                    liveData2.element = r0;
                    if (liveData2.element != 0) {
                        MediatorLiveData<Y> mediatorLiveData3 = result;
                        T t2 = liveData2.element;
                        Intrinsics.checkNotNull(t2);
                        final MediatorLiveData<Y> mediatorLiveData4 = result;
    ...
    public static final /* synthetic */ LiveData switchMap(LiveData $this$switchMap, final Function switchMapFunction) {
        ...
        result.addSource($this$switchMap, new Observer<X>() { // from class: androidx.lifecycle.Transformations$switchMap$2
            ...
            public void onChanged(X value) {
                LiveData newLiveData = (LiveData) switchMapFunction.apply(value);
                ...
                if (this.liveData != null) {
                    ...
                    mediatorLiveData2.addSource(obj2, new Transformations$sam$androidx_lifecycle_Observer$0(new Function1<Y, Unit>() { // from class: androidx.lifecycle.Transformations$switchMap$2$onChanged$1
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(Object obj3) {
                            invoke2((Transformations$switchMap$2$onChanged$1<Y>) obj3);
                            return Unit.INSTANCE;
                        }
