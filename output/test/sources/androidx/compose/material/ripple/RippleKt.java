...
public final class RippleKt {
    ...
    public static final Indication m1286rememberRipple9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        float radius2;
        long color2;
        Object value$iv$iv;
        ...
        if ((i & 2) == 0) {
            ...
            radius2 = Dp.INSTANCE.m5238getUnspecifiedD9Ej5fM();
        }
        if ((i & 4) == 0) {
            color2 = color;
        } else {
            color2 = Color.INSTANCE.m2985getUnspecified0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1635163520, $changed, -1, "androidx.compose.material.ripple.rememberRipple (Ripple.kt:76)");
        }
        State colorState = SnapshotStateKt.rememberUpdatedState(Color.m2939boximpl(color2), $composer, ($changed >> 6) & 14);
        Object key1$iv = Boolean.valueOf(bounded2);
        Object key2$iv = Dp.m5216boximpl(radius2);
