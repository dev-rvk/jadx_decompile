...
public final class SwipeableV2Kt {
    ...
    public static final <T> Modifier swipeAnchors(Modifier $this$swipeAnchors, final SwipeableV2State<T> state, final Set<? extends T> possibleValues, final AnchorChangeHandler<T> anchorChangeHandler, final Function2<? super T, ? super IntSize, Float> calculateAnchor) {
        ...
        return $this$swipeAnchors.then(new SwipeAnchorsModifierImpl(new Function1<Density, Unit>() { // from class: androidx.compose.material3.SwipeableV2Kt$swipeAnchors$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                m1811invokeozmzZPI(intSize.getPackedValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-ozmzZPI, reason: not valid java name */
            public final void m1811invokeozmzZPI(long layoutSize) {
                ...
                for (Object element$iv : $this$forEach$iv) {
                    Float anchorValue = function2.invoke(element$iv, IntSize.m5370boximpl(layoutSize));
                    if (anchorValue != null) {
    ...
    public static final <T> SwipeableV2State<T> rememberSwipeableV2State(final T initialValue, final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> function1, Composer $composer, int $changed, int i) {
        ...
        SwipeableV2State<T> swipeableV2State = (SwipeableV2State) RememberSaveableKt.m2596rememberSaveable(new Object[]{initialValue, animationSpec, function1}, (Saver) SwipeableV2State.INSTANCE.m1813SavereqLRuRQ(animationSpec, function1, SwipeableV2Defaults.INSTANCE.getPositionalThreshold(), SwipeableV2Defaults.INSTANCE.m1809getVelocityThresholdD9Ej5fM()), (String) null, (Function0) new Function0<SwipeableV2State<T>>() { // from class: androidx.compose.material3.SwipeableV2Kt$rememberSwipeableV2State$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
            ...
            public final SwipeableV2State<T> invoke() {
                return new SwipeableV2State<>(initialValue, animationSpec, function1, SwipeableV2Defaults.INSTANCE.getPositionalThreshold(), SwipeableV2Defaults.INSTANCE.m1809getVelocityThresholdD9Ej5fM(), null);
            }
        }, $composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Function2<Density, Float, Float> m1810fixedPositionalThreshold0680j_4(final float threshold) {
        return new Function2<Density, Float, Float>() { // from class: androidx.compose.material3.SwipeableV2Kt$fixedPositionalThreshold$1
            ...
            public final Float invoke(Density $this$null, float it) {
                Intrinsics.checkNotNullParameter($this$null, "$this$null");
                return Float.valueOf($this$null.mo329toPx0680j_4(threshold));
            }
        };
    }
