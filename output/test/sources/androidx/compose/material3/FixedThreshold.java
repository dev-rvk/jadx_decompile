...
public final /* data */ class FixedThreshold implements ThresholdConfig {
    ...
    public static /* synthetic */ FixedThreshold m1534copy0680j_4$default(FixedThreshold fixedThreshold, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = fixedThreshold.offset;
        }
        return fixedThreshold.m1535copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4, reason: not valid java name */
    public final FixedThreshold m1535copy0680j_4(float offset) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof FixedThreshold) && Dp.m5223equalsimpl0(this.offset, ((FixedThreshold) other).offset);
    }

    public int hashCode() {
        return Dp.m5224hashCodeimpl(this.offset);
    }

    public String toString() {
        return "FixedThreshold(offset=" + ((Object) Dp.m5229toStringimpl(this.offset)) + ')';
    }
    ...
    public float computeThreshold(Density $this$computeThreshold, float fromValue, float toValue) {
        ...
        return ($this$computeThreshold.mo329toPx0680j_4(this.offset) * Math.signum(toValue - fromValue)) + fromValue;
    }
}
