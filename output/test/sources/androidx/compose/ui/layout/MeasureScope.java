...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m4223roundToPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo322roundToPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m4224roundToPx0680j_4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo323roundToPx0680j_4($receiver);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m4225toDpGaN1DYA(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo324toDpGaN1DYA($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m4226toDpu2uoSUM(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo325toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m4227toDpu2uoSUM(MeasureScope $this, int $receiver) {
            return MeasureScope.super.mo326toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m4228toDpSizekrfVVM(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo327toDpSizekrfVVM($receiver);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m4229toPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo328toPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m4230toPx0680j_4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo329toPx0680j_4($receiver);
        }
        ...
        public static long m4231toSizeXkaWNTQ(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo330toSizeXkaWNTQ($receiver);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m4232toSp0xMU5do(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo331toSp0xMU5do($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m4233toSpkPz2Gy4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo332toSpkPz2Gy4($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m4234toSpkPz2Gy4(MeasureScope $this, int $receiver) {
            return MeasureScope.super.mo333toSpkPz2Gy4($receiver);
        }
