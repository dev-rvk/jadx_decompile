...
final class ClickableSemanticsNode extends Modifier.Node implements SemanticsModifierNode {
    ...
    public final void m208updateUMe6uN4(boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick) {
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        this.enabled = enabled;
        this.onClickLabel = onClickLabel;
        this.role = role;
    ...
    public void applySemantics(SemanticsPropertyReceiver $this$applySemantics) {
        ...
        if (this.role != null) {
            ...
            SemanticsPropertiesKt.m4582setRolekuIjeqM($this$applySemantics, role.getValue());
        }
