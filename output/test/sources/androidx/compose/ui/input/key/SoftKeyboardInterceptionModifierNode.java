...
public interface SoftKeyboardInterceptionModifierNode extends DelegatableNode {
    ...
    boolean mo3622onInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event);

    /* renamed from: onPreInterceptKeyBeforeSoftKeyboard-ZmokQxo */
    boolean mo3623onPreInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event);
}
