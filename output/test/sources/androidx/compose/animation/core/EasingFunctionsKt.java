    ...
    private static final Easing EaseInOutElastic = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseInOutElastic$1
        ...
        public final float transform(float fraction) {
            ...
            if (0.0f <= fraction && fraction <= 0.5f) {
                return (float) ((-(((float) Math.pow(r3, (fraction * 20.0f) - 10.0f)) * Math.sin(((20.0f * fraction) - 11.125f) * 1.3962634015954636d))) / 2.0f);
            }
