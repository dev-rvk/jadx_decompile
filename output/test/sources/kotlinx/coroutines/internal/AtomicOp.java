...
public abstract class AtomicOp<T> extends OpDescriptor {
    ...
    private final Object decide(Object decision) {
        ...
        Object current = _consensus$FU.get(this);
        return current != AtomicKt.NO_DECISION ? current : AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_consensus$FU, this, AtomicKt.NO_DECISION, decision) ? decision : _consensus$FU.get(this);
    }
