...
public interface ReceiveChannel<E> {
    ...
    Object mo7120receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo7121tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo7121tryReceivePtdJZtk = receiveChannel.mo7121tryReceivePtdJZtk();
            if (ChannelResult.m7136isSuccessimpl(mo7121tryReceivePtdJZtk)) {
                return (E) ChannelResult.m7132getOrThrowimpl(mo7121tryReceivePtdJZtk);
            }
            Throwable m7130exceptionOrNullimpl = ChannelResult.m7130exceptionOrNullimpl(mo7121tryReceivePtdJZtk);
            if (m7130exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m7130exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L38:
                ...
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m7131getOrNullimpl(r3)
                return r3
            */
