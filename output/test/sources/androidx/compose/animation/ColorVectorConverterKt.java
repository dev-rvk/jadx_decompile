        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            ...
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m44invoke8_81llA(color.m2959unboximpl());
                }

                /* renamed from: invoke-8_81llA, reason: not valid java name */
                public final AnimationVector4D m44invoke8_81llA(long color) {
                    long m2946convertvNxB06k = Color.m2946convertvNxB06k(color, ColorSpaces.INSTANCE.getOklab());
                    float l = Color.m2940component1impl(m2946convertvNxB06k);
                    float a = Color.m2941component2impl(m2946convertvNxB06k);
                    float b = Color.m2942component3impl(m2946convertvNxB06k);
                    float alpha = Color.m2943component4impl(m2946convertvNxB06k);
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m2939boximpl(m45invokevNxB06k(animationVector4D));
                }

                /* renamed from: invoke-vNxB06k, reason: not valid java name */
                public final long m45invokevNxB06k(AnimationVector4D vector) {
                    Intrinsics.checkNotNullParameter(vector, "vector");
                    return Color.m2946convertvNxB06k(ColorKt.Color(RangesKt.coerceIn(vector.getV2(), 0.0f, 1.0f), RangesKt.coerceIn(vector.getV3(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV4(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV1(), 0.0f, 1.0f), ColorSpaces.INSTANCE.getOklab()), ColorSpace.this);
                }
            });
        }
    };
