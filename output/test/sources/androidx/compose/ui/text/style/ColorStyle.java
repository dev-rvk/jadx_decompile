...
public final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m4998copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m5000copy8_81llA(j);
    }
    ...
    public final ColorStyle m5000copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m2950equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m2957toStringimpl(this.value)) + ')';
    }
    ...
    public final long m5001getValue0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m2951getAlphaimpl(mo4997getColor0d7_KjU());
    }
}
