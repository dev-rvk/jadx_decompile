...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5218constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m5218constructorimpl((float) 4.0d);
    ...
    public final float m2264getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2265getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }
