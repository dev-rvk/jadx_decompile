...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo15measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        int width = Constraints.m5172getHasFixedWidthimpl(constraints) ? Constraints.m5174getMaxWidthimpl(constraints) : 0;
        int height = Constraints.m5171getHasFixedHeightimpl(constraints) ? Constraints.m5173getMaxHeightimpl(constraints) : 0;
        return MeasureScope.layout$default(measure, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
