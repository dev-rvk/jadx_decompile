...
public final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    */
    ...
    public void update(CombinedClickableNode node) {
        ...
        node.m213updatecJG_KMw(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int result4 = (((result3 + (role != null ? Role.m4565hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
