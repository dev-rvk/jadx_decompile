...
final class KeyInputNode extends Modifier.Node implements KeyInputModifierNode {
    ...
    public boolean mo145onKeyEventZmokQxo(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        Function1<? super KeyEvent, Boolean> function1 = this.onEvent;
        if (function1 != null) {
            return function1.invoke(KeyEvent.m3918boximpl(event)).booleanValue();
        }
        return false;
    }
    ...
    public boolean mo147onPreKeyEventZmokQxo(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
