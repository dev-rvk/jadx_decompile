...
public final class TransparentObserverSnapshot extends Snapshot {
    ...
    public TransparentObserverSnapshot(Snapshot previousSnapshot, Function1<Object, Unit> function1, boolean mergeParentObservers, boolean ownsPreviousSnapshot) {
        ...
        mergedReadObserver = SnapshotKt.mergedReadObserver(function1, readObserver$runtime_release, this.mergeParentObservers);
    ...
    public void mo2599recordModified$runtime_release(StateObject state) {
        ...
        getCurrentSnapshot().mo2599recordModified$runtime_release(state);
    }
