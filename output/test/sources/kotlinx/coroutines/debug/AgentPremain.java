...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m5615constructorimpl = Result.m5615constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5615constructorimpl = Result.m5615constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m5621isFailureimpl(m5615constructorimpl) ? null : m5615constructorimpl);
