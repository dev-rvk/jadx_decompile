        ...
        this.nestedScrollConnection = new NestedScrollConnection() { // from class: androidx.compose.material3.PinnedScrollBehavior$nestedScrollConnection$1
            ...
            public long mo337onPostScrollDzOQY0M(long consumed, long available, int source) {
                ...
                if ((Offset.m2711getYimpl(consumed) == 0.0f) && Offset.m2711getYimpl(available) > 0.0f) {
                    ...
                    state2.setContentOffset(state2.getContentOffset() + Offset.m2711getYimpl(consumed));
                }
                return Offset.INSTANCE.m2726getZeroF1C5BW0();
            }
        };
