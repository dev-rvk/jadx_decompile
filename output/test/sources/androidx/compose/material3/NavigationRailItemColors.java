...
public final class NavigationRailItemColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationRailItemColors) && Color.m2950equalsimpl0(this.selectedIconColor, ((NavigationRailItemColors) other).selectedIconColor) && Color.m2950equalsimpl0(this.unselectedIconColor, ((NavigationRailItemColors) other).unselectedIconColor) && Color.m2950equalsimpl0(this.selectedTextColor, ((NavigationRailItemColors) other).selectedTextColor) && Color.m2950equalsimpl0(this.unselectedTextColor, ((NavigationRailItemColors) other).unselectedTextColor) && Color.m2950equalsimpl0(this.selectedIndicatorColor, ((NavigationRailItemColors) other).selectedIndicatorColor) && Color.m2950equalsimpl0(this.disabledIconColor, ((NavigationRailItemColors) other).disabledIconColor) && Color.m2950equalsimpl0(this.disabledTextColor, ((NavigationRailItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }
