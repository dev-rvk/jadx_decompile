...
public final class LazyGridStateKt {
    public static final LazyGridState rememberLazyGridState(int initialFirstVisibleItemIndex, int initialFirstVisibleItemScrollOffset, Composer $composer, int $changed, int i) {
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            key1$iv = (Function0) new Function0<LazyGridState>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridStateKt$rememberLazyGridState$1$1
        ...
        LazyGridState lazyGridState = (LazyGridState) RememberSaveableKt.m2596rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) key2$iv2, $composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
