...
public final class LayoutIntrinsics {
    ...
    public final float getMinIntrinsicWidth() {
        ...
        this._minIntrinsicWidth = LayoutIntrinsicsKt.minIntrinsicWidth(this.charSequence, this.textPaint);
        return this._minIntrinsicWidth;
    }
    ...
    public final float getMaxIntrinsicWidth() {
        ...
        if (desiredWidth == null) {
            desiredWidth = Float.valueOf((float) Math.ceil(Layout.getDesiredWidth(this.charSequence, 0, this.charSequence.length(), this.textPaint)));
        }
        ...
        this._maxIntrinsicWidth = desiredWidth.floatValue();
        return this._maxIntrinsicWidth;
    }
}
