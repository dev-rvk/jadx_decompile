...
public final class ComposablesKt {
    ...
    public static final /* synthetic */ <T, E extends Applier<?>> void ComposeNode(final Function0<? extends T> factory, Function1<? super Updater<T>, Unit> update, Composer composer, int i) {
        ...
        update.invoke(Updater.m2582boximpl(Updater.m2583constructorimpl(composer)));
        composer.endNode();
        composer.endReplaceableGroup();
    }
    ...
    public static final /* synthetic */ <T, E extends Applier<?>> void ComposeNode(Function0<? extends T> factory, Function1<? super Updater<T>, Unit> update, Function3<? super SkippableUpdater<T>, ? super Composer, ? super Integer, Unit> skippableUpdate, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        update.invoke(Updater.m2582boximpl(Updater.m2583constructorimpl($composer)));
        skippableUpdate.invoke(SkippableUpdater.m2574boximpl(SkippableUpdater.m2575constructorimpl($composer)), $composer, Integer.valueOf(($changed >> 3) & 112));
