...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m378setBefore0680j_4(float f) {
        this.before = f;
    }
    ...
    public final void m377setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult mo241measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        m364alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m364alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, this.before, this.after, measurable, constraints);
