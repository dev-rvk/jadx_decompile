...
public final class InternalPointerEvent {
    ...
    public final boolean m3998issuesEnterExitEvent0FcD4WY(long pointerId) {
        Object it$iv;
        ...
        while (true) {
            if (index$iv$iv < size) {
                ...
                if (PointerId.m4051equalsimpl0(it.m4081getIdJ3iCeTQ(), pointerId)) {
                    break;
                }
                index$iv$iv++;
            } else {
