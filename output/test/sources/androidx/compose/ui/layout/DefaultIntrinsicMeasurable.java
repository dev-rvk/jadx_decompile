...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo4186measureBRTryo0(long constraints) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(width, Constraints.m5173getMaxHeightimpl(constraints));
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m5174getMaxWidthimpl(constraints), height);
    }
