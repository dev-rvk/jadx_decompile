...
final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m80targetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long preEnter = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5346getZeronOccac() : slideOffset2.invoke(IntSize.m5370boximpl(fullSize)).getPackedValue();
        Slide value2 = this.slideOut.getValue();
        long postExit = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5346getZeronOccac() : slideOffset.invoke(IntSize.m5370boximpl(fullSize)).getPackedValue();
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SlideModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                State slideOffset = lazyAnimation.animate(transitionSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.SlideModifier$measure$1$slideOffset$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                        return IntOffset.m5327boximpl(m81invokeBjo55l4(enterExitState));
                    }

                    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m81invokeBjo55l4(EnterExitState it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        return SlideModifier.this.m80targetValueByStateoFUgxo0(it, j);
                    }
                });
                Placeable.PlacementScope.m4246placeWithLayeraW9wM$default(layout, placeable, slideOffset.getValue().getPackedValue(), 0.0f, null, 6, null);
            }
        }, 4, null);
    }
}
