...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline mo720createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection);
    ...
    public final Outline mo212createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        float topStart;
        float bottomStart;
        float topEnd;
        float bottomEnd;
        ...
        float topStart2 = this.topStart.mo728toPxTmRCtEA(size, density);
        float topEnd2 = this.topEnd.mo728toPxTmRCtEA(size, density);
        float bottomEnd2 = this.bottomEnd.mo728toPxTmRCtEA(size, density);
        float bottomStart2 = this.bottomStart.mo728toPxTmRCtEA(size, density);
        float minDimension = Size.m2778getMinDimensionimpl(size);
        ...
        if (topStart >= 0.0f && topEnd >= 0.0f && bottomEnd >= 0.0f && bottomStart >= 0.0f) {
            return mo720createOutlineLjSzlW0(size, topStart, topEnd, bottomEnd, bottomStart, layoutDirection);
        }
