...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
            ...
            final Function2<Selectable, Selectable, Integer> function2 = new Function2<Selectable, Selectable, Integer>() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl$sort$1
                ...
                public final Integer invoke(Selectable a, Selectable b) {
                    ...
                    if (layoutCoordinatesA != null) {
                        positionA = LayoutCoordinates.this.mo4194localPositionOfR5De75A(layoutCoordinatesA, Offset.INSTANCE.m2726getZeroF1C5BW0());
                    } else {
                        positionA = Offset.INSTANCE.m2726getZeroF1C5BW0();
                    }
                    if (layoutCoordinatesB != null) {
                        positionB = LayoutCoordinates.this.mo4194localPositionOfR5De75A(layoutCoordinatesB, Offset.INSTANCE.m2726getZeroF1C5BW0());
                    } else {
                        positionB = Offset.INSTANCE.m2726getZeroF1C5BW0();
                    }
                    if (Offset.m2711getYimpl(positionA) == Offset.m2711getYimpl(positionB)) {
                        compareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m2710getXimpl(positionA)), Float.valueOf(Offset.m2710getXimpl(positionB)));
                    } else {
                        compareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m2711getYimpl(positionA)), Float.valueOf(Offset.m2711getYimpl(positionB)));
                    }
    ...
    public void mo939notifySelectionUpdateStartd4ec7I(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment) {
        ...
        if (function3 != null) {
            function3.invoke(layoutCoordinates, Offset.m2699boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo938notifySelectionUpdate5iVPX68(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        ...
        if (function5 != null) {
            return function5.invoke(layoutCoordinates, Offset.m2699boximpl(newPosition), Offset.m2699boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
